                    ...
                    <tbody>
                        @foreach ($pedidos as $pedido)
                            <tr class="">
                                ...
                                <td>{{ $pedido->codigo }}</td>
                                <td>{{ $pedido->estado }}</td>
                                <th scope="col"><a class="btn btn-primary" href="{{ route("admin.detalles.show",$pedido->id)}}">Detalles</a></th>
                                <th scope="col"><a class="btn btn-primary" href="{{ route("admin.pedidos.edit",$pedido->id)}}">Editar</a></th>
                                <th scope="col">
                                </th>
                            </tr>                            
                        @endforeach
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <h2 class="my-3">HISTORIAL PEDIDOS</h2>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
    ...
    <div class="row">       
        ...
        <div class="col-md-12">
            ...
            @endforelse
                ...
                {{-- <tr><td></td><td></td><td></td><td></td><td></td><td>{{ number_format($acumulador_total,2)}}</td><td>{{ number_format($acumulador_nosubsidio,2) }}</td><td></td><td></td></tr> --}}
            </table>             
        </div>
